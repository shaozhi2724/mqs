    ...
    public partial class UpdateForm : XtraForm
    {
        ...
        private void OnFormLoad(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    web.DownloadProgressChanged += new DownloadProgressChangedEventHandler((s, args) => progressBar1.Position = args.ProgressPercentage);
        ...
        private void UpdateProgress(float percent)
        {
            ...
            progressBar1.Position = (int)percent;
        }
        ...
        private void OnFormClosing(object sender, FormClosingEventArgs e)
        {
            if (Updating)
            {
                e.Cancel = XtraMessageBox.Show("停止更新并关闭?", "更新中",
