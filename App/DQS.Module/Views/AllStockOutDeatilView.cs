...
namespace DQS.Module.Views
{
	public class AllStockOutDeatilView : ViewBase
	{
		...
		public AllStockOutDeatilView()
		{
			...
			this.Fields.Add("药品ID", AllStockOutDeatilViewFields.药品ID);
			this.Fields.Add("药品编号", AllStockOutDeatilViewFields.药品编号);
			this.Fields.Add("药品名称", AllStockOutDeatilViewFields.药品名称);
			this.Fields.Add("生产厂商", AllStockOutDeatilViewFields.生产厂商);
			this.Fields.Add("规格", AllStockOutDeatilViewFields.规格);
			this.Fields.Add("剂型", AllStockOutDeatilViewFields.剂型);
			this.Fields.Add("药品类别", AllStockOutDeatilViewFields.药品类别);
	...
	public class AllStockOutDeatilViewFields
	{
		...
		{
			get { return new EntityField("vw_AllStockOutDeatil", 2, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllStockOutDeatil", 3, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllStockOutDeatil", 4, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllStockOutDeatil", 6, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllStockOutDeatil", 8, "药品类别", SqlDbType.NVarChar); }
		}
