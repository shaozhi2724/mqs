...
namespace DQS.Module.Views
{
	public class AllCuringCycleView : ViewBase
	{
		...
		public AllCuringCycleView()
		{
			...
			this.Fields.Add("药品ID", AllCuringCycleViewFields.药品ID);
			this.Fields.Add("药品编号", AllCuringCycleViewFields.药品编号);
			this.Fields.Add("周期编码", AllCuringCycleViewFields.周期编码);
			this.Fields.Add("药品名称", AllCuringCycleViewFields.药品名称);
			this.Fields.Add("养护周期", AllCuringCycleViewFields.养护周期);
			this.Fields.Add("药品名称Spell", AllCuringCycleViewFields.药品名称Spell);
			this.Fields.Add("规格", AllCuringCycleViewFields.规格);
			this.Fields.Add("单位", AllCuringCycleViewFields.单位);
			this.Fields.Add("包装规格", AllCuringCycleViewFields.包装规格);
			this.Fields.Add("剂型", AllCuringCycleViewFields.剂型);
			this.Fields.Add("药品类别", AllCuringCycleViewFields.药品类别);
			this.Fields.Add("批准文号", AllCuringCycleViewFields.批准文号);
	...
	public class AllCuringCycleViewFields
	{
		...
		{
			get { return new EntityField("vw_AllCuringCycle", 0, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllCuringCycle", 1, "药品编号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllCuringCycle", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllCuringCycle", 5, "药品名称Spell", SqlDbType.NVarChar); }
		}

		public static EntityField 规格
		{
			get { return new EntityField("vw_AllCuringCycle", 6, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllCuringCycle", 8, "包装规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllCuringCycle", 10, "药品类别", SqlDbType.NVarChar); }
		}

		public static EntityField 批准文号
		{
			get { return new EntityField("vw_AllCuringCycle", 11, "批准文号", SqlDbType.NVarChar); }
		}
