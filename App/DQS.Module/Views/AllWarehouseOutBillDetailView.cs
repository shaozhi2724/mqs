...
namespace DQS.Module.Views
{
	public class AllWarehouseOutBillDetailView : ViewBase
	{
		...
		public AllWarehouseOutBillDetailView()
		{
			...
			this.Fields.Add("药品ID", AllWarehouseOutBillDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllWarehouseOutBillDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllWarehouseOutBillDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllWarehouseOutBillDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllWarehouseOutBillDetailViewFields.规格);
			this.Fields.Add("剂型", AllWarehouseOutBillDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllWarehouseOutBillDetailViewFields.药品类别);
	...
	public class AllWarehouseOutBillDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllWarehouseOutBillDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllWarehouseOutBillDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllWarehouseOutBillDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllWarehouseOutBillDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllWarehouseOutBillDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
