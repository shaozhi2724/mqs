...
namespace DQS.Module.Views
{
	public class AllInventoryDetailView : ViewBase
	{
		...
		public AllInventoryDetailView()
		{
			...
			this.Fields.Add("产品ID", AllInventoryDetailViewFields.产品ID);
			this.Fields.Add("产品编号", AllInventoryDetailViewFields.产品编号);
			this.Fields.Add("产品名称", AllInventoryDetailViewFields.产品名称);
			this.Fields.Add("产品名称Spell", AllInventoryDetailViewFields.产品名称Spell);
			this.Fields.Add("生产厂商", AllInventoryDetailViewFields.生产厂商);
			this.Fields.Add("规格型号", AllInventoryDetailViewFields.规格型号);
			this.Fields.Add("剂型", AllInventoryDetailViewFields.剂型);
			this.Fields.Add("产品类别", AllInventoryDetailViewFields.产品类别);
	...
	public class AllInventoryDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllInventoryDetail", 1, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllInventoryDetail", 2, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllInventoryDetail", 3, "产品名称", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称Spell
		{
			get { return new EntityField("vw_AllInventoryDetail", 4, "产品名称Spell", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllInventoryDetail", 6, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllInventoryDetail", 8, "产品类别", SqlDbType.NVarChar); }
		}
