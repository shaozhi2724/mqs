...
namespace DQS.Module.Views
{
	public class AllWarehouseInBillDetailView : ViewBase
	{
		...
		public AllWarehouseInBillDetailView()
		{
			...
			this.Fields.Add("产品ID", AllWarehouseInBillDetailViewFields.产品ID);
			this.Fields.Add("产品编号", AllWarehouseInBillDetailViewFields.产品编号);
			this.Fields.Add("产品名称", AllWarehouseInBillDetailViewFields.产品名称);
			this.Fields.Add("生产厂商", AllWarehouseInBillDetailViewFields.生产厂商);
			this.Fields.Add("规格型号", AllWarehouseInBillDetailViewFields.规格型号);
			this.Fields.Add("剂型", AllWarehouseInBillDetailViewFields.剂型);
			this.Fields.Add("产品类别", AllWarehouseInBillDetailViewFields.产品类别);
	...
	public class AllWarehouseInBillDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllWarehouseInBillDetail", 1, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllWarehouseInBillDetail", 2, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllWarehouseInBillDetail", 3, "产品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllWarehouseInBillDetail", 5, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllWarehouseInBillDetail", 7, "产品类别", SqlDbType.NVarChar); }
		}
