...
namespace DQS.Module.Views
{
	public class AllPurchaseBackDetailView : ViewBase
	{
		...
		public AllPurchaseBackDetailView()
		{
			...
			this.Fields.Add("产品ID", AllPurchaseBackDetailViewFields.产品ID);
			this.Fields.Add("产品编号", AllPurchaseBackDetailViewFields.产品编号);
			this.Fields.Add("产品名称", AllPurchaseBackDetailViewFields.产品名称);
			this.Fields.Add("生产厂商", AllPurchaseBackDetailViewFields.生产厂商);
			this.Fields.Add("规格型号", AllPurchaseBackDetailViewFields.规格型号);
			this.Fields.Add("剂型", AllPurchaseBackDetailViewFields.剂型);
			this.Fields.Add("产品类别", AllPurchaseBackDetailViewFields.产品类别);
	...
	public class AllPurchaseBackDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllPurchaseBackDetail", 1, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllPurchaseBackDetail", 2, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllPurchaseBackDetail", 3, "产品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllPurchaseBackDetail", 5, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllPurchaseBackDetail", 7, "产品类别", SqlDbType.NVarChar); }
		}
