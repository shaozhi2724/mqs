...
namespace DQS.Module.Views
{
	public class AllSaleBackReviewView : ViewBase
	{
		...
		public AllSaleBackReviewView()
		{
			...
			this.Fields.Add("产品ID", AllSaleBackReviewViewFields.产品ID);
			this.Fields.Add("产品编号", AllSaleBackReviewViewFields.产品编号);
			this.Fields.Add("产品名称", AllSaleBackReviewViewFields.产品名称);
			this.Fields.Add("生产厂商", AllSaleBackReviewViewFields.生产厂商);
			this.Fields.Add("规格型号", AllSaleBackReviewViewFields.规格型号);
			this.Fields.Add("剂型", AllSaleBackReviewViewFields.剂型);
			this.Fields.Add("产品类别", AllSaleBackReviewViewFields.产品类别);
	...
	public class AllSaleBackReviewViewFields
	{
		...
		{
			get { return new EntityField("vw_AllSaleBackReview", 12, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllSaleBackReview", 13, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllSaleBackReview", 14, "产品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSaleBackReview", 16, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSaleBackReview", 18, "产品类别", SqlDbType.NVarChar); }
		}
