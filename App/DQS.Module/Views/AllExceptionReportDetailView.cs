...
namespace DQS.Module.Views
{
	public class AllExceptionReportDetailView : ViewBase
	{
		...
		public AllExceptionReportDetailView()
		{
			...
			this.Fields.Add("药品ID", AllExceptionReportDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllExceptionReportDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllExceptionReportDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllExceptionReportDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllExceptionReportDetailViewFields.规格);
			this.Fields.Add("剂型", AllExceptionReportDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllExceptionReportDetailViewFields.药品类别);
	...
	public class AllExceptionReportDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllExceptionReportDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllExceptionReportDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllExceptionReportDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllExceptionReportDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllExceptionReportDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
