...
namespace DQS.Module.Views
{
	public class AllPurchaseDetailView : ViewBase
	{
		...
		public AllPurchaseDetailView()
		{
			...
			this.Fields.Add("药品ID", AllPurchaseDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllPurchaseDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllPurchaseDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllPurchaseDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllPurchaseDetailViewFields.规格);
			this.Fields.Add("剂型", AllPurchaseDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllPurchaseDetailViewFields.药品类别);
	...
	public class AllPurchaseDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllPurchaseDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllPurchaseDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllPurchaseDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllPurchaseDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllPurchaseDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
