...
namespace DQS.Module.Views
{
	public class AllSamplingDetailView : ViewBase
	{
		...
		public AllSamplingDetailView()
		{
			...
			this.Fields.Add("产品ID", AllSamplingDetailViewFields.产品ID);
			this.Fields.Add("产品编号", AllSamplingDetailViewFields.产品编号);
			this.Fields.Add("产品名称", AllSamplingDetailViewFields.产品名称);
			this.Fields.Add("生产厂商", AllSamplingDetailViewFields.生产厂商);
			this.Fields.Add("规格型号", AllSamplingDetailViewFields.规格型号);
			this.Fields.Add("剂型", AllSamplingDetailViewFields.剂型);
			this.Fields.Add("产品类别", AllSamplingDetailViewFields.产品类别);
	...
	public class AllSamplingDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllSamplingDetail", 1, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllSamplingDetail", 2, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllSamplingDetail", 3, "产品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSamplingDetail", 5, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSamplingDetail", 7, "产品类别", SqlDbType.NVarChar); }
		}
