...
namespace DQS.Module.Views
{
	public class AllSaleBackDetailView : ViewBase
	{
		...
		public AllSaleBackDetailView()
		{
			...
			this.Fields.Add("药品ID", AllSaleBackDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllSaleBackDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllSaleBackDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllSaleBackDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllSaleBackDetailViewFields.规格);
			this.Fields.Add("剂型", AllSaleBackDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllSaleBackDetailViewFields.药品类别);
	...
	public class AllSaleBackDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllSaleBackDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllSaleBackDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllSaleBackDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSaleBackDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllSaleBackDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
