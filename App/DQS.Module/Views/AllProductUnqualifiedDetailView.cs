...
namespace DQS.Module.Views
{
	public class AllProductUnqualifiedDetailView : ViewBase
	{
		...
		public AllProductUnqualifiedDetailView()
		{
			...
			this.Fields.Add("药品ID", AllProductUnqualifiedDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllProductUnqualifiedDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllProductUnqualifiedDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllProductUnqualifiedDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllProductUnqualifiedDetailViewFields.规格);
			this.Fields.Add("剂型", AllProductUnqualifiedDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllProductUnqualifiedDetailViewFields.药品类别);
	...
	public class AllProductUnqualifiedDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllProductUnqualifiedDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllProductUnqualifiedDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllProductUnqualifiedDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllProductUnqualifiedDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllProductUnqualifiedDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
