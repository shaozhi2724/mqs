...
namespace DQS.Module.Views
{
	public class AllAcceptDetailView : ViewBase
	{
		...
		public AllAcceptDetailView()
		{
			...
			this.Fields.Add("药品ID", AllAcceptDetailViewFields.药品ID);
			this.Fields.Add("药品编号", AllAcceptDetailViewFields.药品编号);
			this.Fields.Add("药品名称", AllAcceptDetailViewFields.药品名称);
			this.Fields.Add("生产厂商", AllAcceptDetailViewFields.生产厂商);
			this.Fields.Add("规格", AllAcceptDetailViewFields.规格);
			this.Fields.Add("剂型", AllAcceptDetailViewFields.剂型);
			this.Fields.Add("药品类别", AllAcceptDetailViewFields.药品类别);
	...
	public class AllAcceptDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllAcceptDetail", 1, "药品ID", SqlDbType.Int); }
		}

		public static EntityField 药品编号
		{
			get { return new EntityField("vw_AllAcceptDetail", 2, "药品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 药品名称
		{
			get { return new EntityField("vw_AllAcceptDetail", 3, "药品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllAcceptDetail", 5, "规格", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllAcceptDetail", 7, "药品类别", SqlDbType.NVarChar); }
		}
