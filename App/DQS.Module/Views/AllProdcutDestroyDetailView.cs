...
namespace DQS.Module.Views
{
	public class AllProdcutDestroyDetailView : ViewBase
	{
		...
		public AllProdcutDestroyDetailView()
		{
			...
			this.Fields.Add("产品ID", AllProdcutDestroyDetailViewFields.产品ID);
			this.Fields.Add("产品编号", AllProdcutDestroyDetailViewFields.产品编号);
			this.Fields.Add("产品名称", AllProdcutDestroyDetailViewFields.产品名称);
			this.Fields.Add("生产厂商", AllProdcutDestroyDetailViewFields.生产厂商);
			this.Fields.Add("规格型号", AllProdcutDestroyDetailViewFields.规格型号);
			this.Fields.Add("剂型", AllProdcutDestroyDetailViewFields.剂型);
			this.Fields.Add("产品类别", AllProdcutDestroyDetailViewFields.产品类别);
	...
	public class AllProdcutDestroyDetailViewFields
	{
		...
		{
			get { return new EntityField("vw_AllProdcutDestroyDetail", 1, "产品ID", SqlDbType.Int); }
		}

		public static EntityField 产品编号
		{
			get { return new EntityField("vw_AllProdcutDestroyDetail", 2, "产品编号", SqlDbType.NVarChar); }
		}

		public static EntityField 产品名称
		{
			get { return new EntityField("vw_AllProdcutDestroyDetail", 3, "产品名称", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllProdcutDestroyDetail", 5, "规格型号", SqlDbType.NVarChar); }
		}
		...
		{
			get { return new EntityField("vw_AllProdcutDestroyDetail", 7, "产品类别", SqlDbType.NVarChar); }
		}
