namespace DQS.AppViews.WarehouseOut.WarehouseOutManager
{
    partial class FrmStockOut
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dteEnd.FormatQueryString = "[出库日期] <= \'{0} 23:59:59\'";
            ...
            this.dteStart.FormatQueryString = "[出库日期] >= \'{0} 00:00:00\'";
            ...
            // txtStoreCode
            // 
            this.txtStoreCode.FormatQueryString = "[出库单号] = \'{0}\'";
            ...
            this.layStart.CustomizationFormText = "出库日期";
