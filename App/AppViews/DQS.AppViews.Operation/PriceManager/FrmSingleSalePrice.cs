...
{
    public partial class FrmSingleSalePrice : DevExpress.XtraEditors.XtraForm
    {
        private int? m_id;

        public FrmSingleSalePrice()
        {
            InitializeComponent();
        }

        private void FrmSingleSalePrice_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.m_id != null)
                {
                    ...
                    priceLists.Fetch(BFIPriceListEntityFields.PriceListType == "销售价格表" &
        ...
        private void SaveAndOpenPriceVersionForm()
        {
            ...
            FrmSingleSalePriceVersion frmSingleSalePriceVersion = new FrmSingleSalePriceVersion(entity);
            frmSingleSalePriceVersion.ShowDialog(this);
            this.popupGrid.SetGridData(m_id.Value);
        }
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if(id != null)
                {
                    ...
                    entity.Fetch();
                    FrmSingleSalePriceVersion frmSingleSalePriceVersion = new FrmSingleSalePriceVersion(entity);
                    frmSingleSalePriceVersion.Tag = Convert.ToInt32(id);
                    frmSingleSalePriceVersion.ShowDialog(this);
                    this.popupGrid.SetGridData(m_id.Value);
                }
            }
