...
{
    public partial class FrmSingleSalePriceVersion : DevExpress.XtraEditors.XtraForm
    {
        private int? m_id;
        private BFIPriceListEntity _priceListEntity;

        public FrmSingleSalePriceVersion()
        {
            InitializeComponent();
        }

        public FrmSingleSalePriceVersion(BFIPriceListEntity priceList)
            : this()
        {
        ...
        private void FrmSingleSalePriceVersion_Load(object sender, EventArgs e)
        {
        ...
        private void SaveAndOpenPriceItemForm()
        {
            ...
            FrmSingleSalePriceItem frmSingleSalePriceItem = new FrmSingleSalePriceItem(entity, _priceListEntity);
            frmSingleSalePriceItem.ShowDialog(this);
            this.popupGrid.SetGridData(m_id.Value);
        }
        ...
        private void btnEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if(id != null)
                {
                    ...
                    FrmSingleSalePriceItem frmSingleSalePriceItem = new FrmSingleSalePriceItem(entity, _priceListEntity);
                    frmSingleSalePriceItem.Tag = Convert.ToInt32(id);
                    frmSingleSalePriceItem.ShowDialog(this);
                    this.popupGrid.SetGridData(m_id.Value);
