...
{
    public partial class FrmSingleSalePriceItem : DevExpress.XtraEditors.XtraForm
    {
        private int? m_id;
        private BFIPriceListVersionEntity _priceListVersion;
        private BFIPriceListEntity _priceList;

        public FrmSingleSalePriceItem()
        {
            InitializeComponent();
        }

        public FrmSingleSalePriceItem(BFIPriceListVersionEntity priceListVersionEntity, BFIPriceListEntity priceListEntity)
            : this()
        {
        ...
        private void FrmSingleSalePriceItem_Load(object sender, EventArgs e)
        {
            Inital();
        }
        ...
        private void Inital()
        {
            ...
            this.cbxPriceStyle.Properties.Items.Add("上次进货价");
            this.cbxPriceStyle.Properties.Items.Add("上次销售价");
        ...
        protected virtual void CustomSetEntity(BFIPriceListItemEntity entity)
        {
            ...
            if (cbxPriceStyle.Text == "上次进货价")
            {
                entity.BasePriceCategoryID = -1;
            }
            else if(cbxPriceStyle.Text == "上次销售价")
            {
                entity.BasePriceCategoryID = -2;
            }
            else
            {
