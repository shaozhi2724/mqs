...
{
    public partial class FrmReceiveAttachmentProgressing : DevExpress.XtraEditors.XtraForm
    {
        private string _suffix = string.Empty;
        private BUSReceiveTemperatureAttachmentEntity _attachment;
        ...
        public FrmReceiveAttachmentProgressing(BUSReceiveTemperatureAttachmentEntity attachment)
        {
            InitializeComponent();
        ...
        public FrmReceiveAttachmentProgressing(int attachmentID, string fullName)
        {
            InitializeComponent();
        ...
        private void DoDownload()
        {
            try
            {
                GlobalMethod.DownAttachment("BUS_ReceiveTemperatureAttachment", "AttachmentContent", "ReceiveTemperatureAttachmentID", this._attachmentID, this._fullName);
                this._flag = true;
            }
            catch (Exception ex)
            {
