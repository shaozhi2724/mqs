...
{
    public partial class FrmAcceptAttachmentProgressing : DevExpress.XtraEditors.XtraForm
    {
        private string _suffix = string.Empty;
        private BUSAcceptAttachmentEntity _attachment;
        ...
        public FrmAcceptAttachmentProgressing(BUSAcceptAttachmentEntity attachment)
        {
            InitializeComponent();
        ...
        public FrmAcceptAttachmentProgressing(int attachmentID, string fullName)
        {
            InitializeComponent();
        ...
        private void DoDownload()
        {
            try
            {
                GlobalMethod.DownAttachment("BUS_AcceptAttachment", "AttachmentContent", "AcceptAttachmentID", this._attachmentID, this._fullName);
                this._flag = true;
            }
            catch (Exception ex)
            {
