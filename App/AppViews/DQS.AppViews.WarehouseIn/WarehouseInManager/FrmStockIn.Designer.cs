namespace DQS.AppViews.WarehouseIn.WarehouseInManager
{
    partial class FrmStockIn
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dteEnd.FormatQueryString = "[入库日期] <= \'{0} 23:59:59\'";
            ...
            this.dteStart.FormatQueryString = "[入库日期] >= \'{0} 00:00:00\'";
            ...
            // txtStoreCode
            // 
            this.txtStoreCode.FormatQueryString = "[入库单号] = \'{0}\'";
            ...
            this.layStart.CustomizationFormText = "入库日期";
