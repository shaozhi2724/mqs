...
{
    partial class FrmSaleBackDeatils
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // txtDealerName
            // 
            this.txtDealerName.FormatQueryString = "[客户名称] LIKE \'%{0}%\' OR [客户Spell] LIKE \'%{0}%\' ";
            ...
            this.layoutControlItem1.CustomizationFormText = "下单日期";
            ...
            this.layoutControlItem1.Text = "下单日期";
            ...
            // layBillCode
            // 
            this.layBillCode.Control = this.txtDealerName;
            this.layBillCode.CustomizationFormText = "客户";
            ...
            this.Name = "FrmSaleBackDeatils";
            this.Text = "FrmSaleBackDeatils";
            this.Load += new System.EventHandler(this.FrmSaleBackDeatils_Load);
