namespace DQS.AppViews.StoreAndCuring.CuringManager
{
    partial class FrmCuringRecord
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dteEnd.FormatQueryString = "[养护日期] <= \'{0}\'";
            ...
            this.dteStart.FormatQueryString = "[养护日期] >= \'{0}\'";
            ...
            this.layStart.CustomizationFormText = "保养日期";
            ...
            this.Name = "FrmCuringRecord";
            this.Text = "FrmCuringRecord";
            this.Load += new System.EventHandler(this.FrmCuringRecord_Load);
