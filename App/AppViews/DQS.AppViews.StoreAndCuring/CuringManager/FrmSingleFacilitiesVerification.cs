...
{
    public partial class FrmSingleFacilitiesVerification : StandardForm
    {
        public FrmSingleFacilitiesVerification()
        {
            InitializeComponent();
        }

        private void FrmSingleFacilitiesVerification_Load(object sender, EventArgs e)
        {
            base.InitPage();
        }
        ...
        protected override void CustomModify()
        {
            ...
            {
                using (FrmFacilitiesVerification verification = new FrmFacilitiesVerification(Convert.ToInt32(id),Convert.ToInt32(fid)))
                {
