...
{
    public partial class FrmMakeCollectionsChooseBill : XtraForm
    {
        public FrmMakeCollectionsChooseBill()
        {
            InitializeComponent();
        }
        ...
        private void GainData()
        {
            ...
            {
                string sql = "EXEC " + FrmSql + " '" + txtDealerCode.Text.Trim() + "','" + txtBillCode.Text.Trim() + "','" + deStartDate.Text + "'";
