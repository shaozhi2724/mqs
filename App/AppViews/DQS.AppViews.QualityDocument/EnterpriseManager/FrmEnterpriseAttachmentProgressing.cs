...
{
    public partial class FrmEnterpriseAttachmentProgressing : XtraForm
    {
        private string _suffix = string.Empty;
        private BFIEnterpriseAttachmentEntity _attachment;
        ...
        public FrmEnterpriseAttachmentProgressing(BFIEnterpriseAttachmentEntity attachment)
        {
            InitializeComponent();
        ...
        public FrmEnterpriseAttachmentProgressing(int attachmentID, string fullName)
        {
            InitializeComponent();
        ...
        private void DoDownload()
        {
            try
            {
                GlobalMethod.DownAttachment("BFI_EnterpriseAttachment", "AttachmentContent", "EnterpriseAttachmentID", this._attachmentID, this._fullName);
                this._flag = true;
            }
            catch (Exception ex)
            {
