...
namespace DQS.AppViews.QualityDocument.ProviderManager
{
    public partial class FrmSingleFirstProvider : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmSingleFirstProvider_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (entity.IsNew())
                {
                    ...
                    pe.Add(ATCUserPageEntityFields.DocumentCode == "FirstProvider");
                    ...
                    approveEntity.DocumentCode = "FirstProvider";
                    ...
                    for (int i = 0; i < data.Rows.Count; i++)
                    {
                        ...
                        notification.FormClass = "FirstProvider";
