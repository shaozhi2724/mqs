...
{
    public partial class FrmSingleFirstProviderChange : DevExpress.XtraEditors.XtraForm
    {
        private Guid m_id;
        private ATCAntiApproveEntity entity;
        public FrmSingleFirstProviderChange()
        {
            InitializeComponent();
        }

        public FrmSingleFirstProviderChange(bool isView)
            : this()
        {
        ...
        private void FrmSingleFirstProviderChange_Load(object sender, EventArgs e)
        {
        ...
        private void btnDealerInfo_Click(object sender, EventArgs e)
        {
            ...
            FrmSingleFirstProviderChangeDetail doc = new FrmSingleFirstProviderChangeDetail();
            doc.Tag = dealerId;
