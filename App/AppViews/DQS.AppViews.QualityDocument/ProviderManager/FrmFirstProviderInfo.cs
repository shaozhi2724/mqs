...
{
    public partial class FrmFirstProviderInfo : StandardForm
    {
        public FrmFirstProviderInfo()
        {
            InitializeComponent();
        }

        private void FrmFirstProviderInfo_Load(object sender, EventArgs e)
        {
        ...
        protected override void CustomQualification()
        {
            ...
            if (id != null)
            {
                using (FrmQualification frmQualification = new FrmQualification(Convert.ToInt32(id), "BFI_Dealer", "DealerID", "ProviderCertificate"))
                {
                    ...
                    if (dealerCode != null && dealerCode != DBNull.Value && approveStatus != null && approveStatus != DBNull.Value)
                    {
                        ...
                        else
                        {
                            ...
                            pe.Add(ATCApproveEntityFields.DocumentCode == "FirstProvider");
        ...
        protected override void CustomModifyRequest()
        {
            try
            {
                ...
                if (id != null)
                {
                    ...
                    antiApproveEntities.Fetch(ATCAntiApproveEntityFields.DocumentCode == "FirstProvider"
                    ...
                    FrmSingleFirstProviderAntiApprove singleForm = new FrmSingleFirstProviderAntiApprove();
        ...
        protected override void CustomPrint()
        {
            ...
            if (id != null)
            {
                base.SinglePrint("首营客户", "FirstProvider", "单位ID = " + id);
            }
