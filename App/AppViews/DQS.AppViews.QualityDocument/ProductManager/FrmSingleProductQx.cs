...
{
    public partial class FrmSingleProductQx : DevExpress.XtraEditors.XtraForm
    {
        private int? m_id;

        public FrmSingleProductQx()
        {
            InitializeComponent();
        }

        private void FrmSingleProductQx_Load(object sender, EventArgs e)
        {
