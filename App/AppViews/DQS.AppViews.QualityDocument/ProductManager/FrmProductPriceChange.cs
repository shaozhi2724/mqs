...
{
    public partial class FrmProductPriceChange : StandardForm
    {
        ...
        private void FrmProductPriceChange_Load(object sender, EventArgs e)
        {
            LoadType("BUS_ProductPriceChange", "AppStatus", cbxBillStatus);
        ...
        protected override void CustomApprove()
        {
            ...
            if (id != null && id != DBNull.Value)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(GlobalItem.g_DbConnectStrings))
                    {
                        string sql = @"EXEC sp_EInsertProductPriceChange {0}";
