...
{
    public partial class FrmSingleFirstProductQx : DevExpress.XtraEditors.XtraForm
    {
        private int? m_id;


        public FrmSingleFirstProductQx()
        {
            InitializeComponent();
        }

        private void FrmSingleFirstProductQx_Load(object sender, EventArgs e)
        {
